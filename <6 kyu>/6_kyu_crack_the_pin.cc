...
void MD5::update(const unsigned char input[], size_type length) {
    ...
    if (length >= firstpart) {
       ...
       // index = 0; //The value is never used.
    } else
        i = 0;
...
void pin_generate(int n, char pin[]) {
    /* Generate char * pin from 00000 to 99999.*/
...
int main() {
    ...
    std::cout << crack("86aa400b65433b608a9db30070ec60cd") << std::endl;
    return 0;
}